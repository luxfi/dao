...
import tokenPath from "./tokensLib";
export interface PARSTokenProps extends SvgIconProps {
    name: keyof typeof tokenPath;
    viewBox?: string;
    fontSize?: SvgIconProps["fontSize"];
}
/**
 * Primary Token Component for UI. This component displays a SVG Token Asset from the Lux DAO Token Library.
 *
 ...
 */
declare const Token: FC<PARSTokenProps>;
export default Token;
export declare type TokenName = keyof typeof tokenPath;
